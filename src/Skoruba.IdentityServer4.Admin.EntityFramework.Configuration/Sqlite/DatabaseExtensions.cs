...
namespace Skoruba.IdentityServer4.Admin.EntityFramework.Configuration.Sqlite
{
    public static class DatabaseExtensions
    {
            ...
            where TDataProtectionDbContext : DbContext, IDataProtectionKeyContext
        {
            ...
            // DataProtectionKey DB from existing connection
            services.AddDbContext<TDataProtectionDbContext>(options => options.UseSqlite(dataProtectionConnectionString, optionsSql => optionsSql.MigrationsAssembly(migrationsAssembly)));
        }
    }
}